...
public class Gui_Crear {
    ...
    public Gui_Crear(JFrame ventana, CardLayout cardLayout, JPanel pnlCards, String usuarioActual) {
    ...
    private JPanel construirSidebar() {
        ...
        for (int i = 0; i < opNombres.length; i++) {
            ...
            if (idx == 0) {
                btnNav.addActionListener(e -> cardLayout.show(pnlCards, "home"));
            }
            if (idx == 1) {
    ...
    private JPanel construirAreaCrear() {
        ...
        btnCancelar.addActionListener(e -> cardLayout.show(pnlCards, "home"));
